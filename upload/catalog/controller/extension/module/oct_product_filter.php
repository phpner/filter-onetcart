...
class ControllerExtensionModuleOctProductFilter extends Controller {
    ...
    public function index() {
        ...
        $this->document->addScript('catalog/view/javascript/phpner_product_filter/nouislider.js');
        $this->document->addScript('catalog/view/javascript/phpner_product_filter/wNumb.js');
        $this->document->addStyle('catalog/view/javascript/phpner_product_filter/nouislider.css');
        $this->document->addStyle('catalog/view/javascript/phpner_product_filter/dynamic_stylesheet.css');
        ...
        if ($oct_product_filter_data['review_status']) {
            ...
            for ($review_key = 1; $review_key <= 5; $review_key++) {
                ...
                $data['filter_review'][] = array(
                    ...
                    'thumb' => 'catalog/view/theme/default/image/phpner_product_filter/star_' . $review_key . '.png',
